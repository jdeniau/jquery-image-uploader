void 0!==typeof jQuery&&function(g){g.fn.imageUploader=function(h){function r(b){b.preventDefault();b.stopPropagation();return a.onDragLeave()}function s(b){b.preventDefault();b.stopPropagation();return a.onDragEnter()}function t(b){b.preventDefault();b.stopPropagation();return a.onDragOver()}function u(b){b.preventDefault();b.stopPropagation();n(b.originalEvent.dataTransfer.files);return a.onDrop()}function p(){a.thumbnails&&(d=a.thumbnails.div.find('[data-upload-status="waiting"]:first'),d.attr("data-upload-status",
...
c/h,g(e).css("top",parseInt((c-e.height)/2)+"px"))):(0<b?e.width=b:0<c&&(e.width=c*h),0<c?e.height=c:0<b&&(e.height=b/h));g(e).show("slow")};a.thumbnails.div.append(d)},d.readAsDataURL(b[c]));try{var h=b[c];m.push(h);l.push(h);k()}catch(j){q()}}else alert("files api not supported")}var a=g.extend({},g.fn.imageUploader.defaults,h);a.dropZone=g(this);var j=!0,l=[],m=[],d=null,c=new XMLHttpRequest;null!=a.dropZone&&(a.dropZone.on("dragleave",r),a.dropZone.on("dragenter",s),a.dropZone.on("dragover",t),
a.dropZone.on("drop",u));null!=a.fileField&&(a.dropZone.on("click",function(){a.fileField.trigger("click")}),"string"==typeof a.fileField&&(a.fileField=g(a.fileField)),a.fileField.on("change",y),!0==a.hideFileField&&a.fileField.hide());a.thumbnails&&("object"!=typeof a.thumbnails&&(h=null,"string"==typeof a.thumbnails&&(h=g(a.thumbnails)),a.thumbnails={div:h,width:null,height:null}),"string"==typeof a.thumbnails.div&&(a.thumbnails.div=g(a.thumbnails.div)),"object"==typeof a.thumbnails&&void 0==a.thumbnails.div&&
(a.thumbnails.div=null),null==a.thumbnails.div&&(a.thumbnails.div=g('<div class="fileUploadThumbnails" />'),a.dropZone.after(a.thumbnails.div)));return this};g.fn.imageUploader.defaults={fileField:null,hideFileField:!0,url:null,thumbnails:{div:null,width:null,height:null},maxFileSize:0,allowDuplicate:!1,onFilesSelected:function(){return!1},onDragLeave:function(){return!1},onDragEnter:function(){return!1},onDragOver:function(){return!1},onDrop:function(){return!1},onUploadProgress:function(){return!1},
beforeUpload:function(){return!0},afterUpload:function(){return!1},error:function(g){alert(g)},debug:!1}}(jQuery);