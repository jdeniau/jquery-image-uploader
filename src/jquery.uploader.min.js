...
(a=c(this.options.thumbnails));this.options.thumbnails={div:a,width:null,height:null}}"string"==typeof this.options.thumbnails.div&&(this.options.thumbnails.div=c(this.options.thumbnails.div));"object"==typeof this.options.thumbnails&&void 0==this.options.thumbnails.div&&(this.options.thumbnails.div=null);null==this.options.thumbnails.div&&(this.options.thumbnails.div=c('<div class="fileUploadThumbnails" />'),this.options.dropZone.after(this.options.thumbnails.div))}},main:function(){null!=this.options.dropZone&&
(this.options.dropZone.on("dragstart",this.onDragStart),this.options.dropZone.on("dragend",this.onDragEnd),this.options.dropZone.on("dragleave",this.onDragLeave),this.options.dropZone.on("dragenter",this.onDragEnter),this.options.dropZone.on("dragover",this.onDragOver),this.options.dropZone.on("drop",this.onDrop));null!=this.options.fileField&&(this.options.dropZone.on("click",function(){this.options.fileField.trigger("click")}),"string"==typeof this.options.fileField&&(this.options.fileField=c(this.options.fileField)),
